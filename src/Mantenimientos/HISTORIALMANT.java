...
public class HISTORIALMANT extends javax.swing.JInternalFrame {
    ...
    private void ListaHistorialManto() {
        ...
        ArrayList<maquinas> result1 = Ingreso_Mantenimiento.ListarHistorial(COD.getText());
        recargarTable(result1);
    }
    
    public void recargarTable(ArrayList<maquinas> list) {
        Object[][] datos1 = new Object[list.size()][4];
        int i = 0;
        for (maquinas p : list)
        {
            datos1[i][0] = p.getNO();
        ...
        HISTORIAL.setModel(new javax.swing.table.DefaultTableModel(
                datos1,
                new String[]{
                    "CODIGO","DESCRIPCION","DESCRIPCION DE MANTENIMIENTO","FECHA MANTENIMIENTO"
                }) {
                     @Override
        ...
        TableColumn columna3 = HISTORIAL.getColumn("DESCRIPCION DE MANTENIMIENTO");
