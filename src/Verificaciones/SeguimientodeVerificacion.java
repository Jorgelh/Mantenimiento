 ...
 * @author jluis
 */
public class SeguimientodeVerificacion extends javax.swing.JInternalFrame {
     ...
     */
    public SeguimientodeVerificacion() {
        initComponents();
        CODIGO.requestFocus();
        ListaMaquinas();
    ...
    /*private void calculardias() {
        try {
            ...
            Logger.getLogger(SeguimientodeVerificacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void actualizarVerificacion() {
        try {
            Connection con = Conn.getConnection();
            Statement stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("update verificacion set estado = 2 where id_verifi =" + id_verificacion);
            rs.close();
            stmt.close();
            con.close();
        } catch (SQLException error) {
    ...
    /*public void insertarindicador() {
        ...
        try {
            ...
            m.setId_matenimiento(id_verificacion);
    ...
    private void initComponents() {
        ...
        setTitle("SEGUIMIENTO VERIFICACION");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(MESES, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel7.setText("FECHA INICIO VERIFICACION");
        ...
        jLabel13.setText("FECHA FIN VERIFICACION");
        ...
        maquinas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "DESCRIPCION", "FECHA VERIFICACION"
            }
        ));
    ...
    private void maquinasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_maquinasMouseClicked
        ...
        try {
            verificacion p = Ingreso_Verificaciones.buscarMaquinaVerifi(Integer.parseInt(String.valueOf(maquinas.getModel().getValueAt(maquinas.getSelectedRow(), 0))));
            ...
            id_verificacion = p.getId_verifi();
        } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        idnew();
        if (codigoid != 0 && id != 0 && id_verificacion != 0 && FECHAIDEAL.getText().compareTo("") != 0 && FECHAINICIO.getDate() != null && FECHAIDEAL.getText().compareTo("") != 0 && FECHAPROXIMO.getText().compareTo("") != 0) {
            ...
            try {
                ...
                Ingreso_Verificaciones.IngresoVerifi2(m);
    ...
    private void ListaMaquinas() {
        ArrayList<maquinas> result1 = Ingreso_Verificaciones.ListarVerifiSeguimiento(CODIGO.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeguimientodeVerificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeguimientodeVerificacion().setVisible(true);
            }
        });
    }
